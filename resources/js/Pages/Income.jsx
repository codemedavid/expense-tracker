            ...
            <div className="flex flex-col sm:flex-row gap-10">
                <div className="w-[65%] p-4">
                    <div className="bg-white h-24 w-full rounded-md flex">
                        ...
                        <div className="p-5 h-auto">
                            <p>
                                ...
                                money you keep, how hard it works for you, and
                    ...
                    <div className="mt-10 mx-10">
                        ...
                        <p className="px-1 text-xl mt-4">
                            Potential Income This Month{" "}
                            <span className="font-bold">P200,500</span>
                        </p>
                    </div>
                    ...
                    <div className="bg-blue-800 w-full flex flex-wrap p-3 mt-8 mx-2 gap-2 rounded-lg">
                        ...
                        <div className="w-44 h-24 bg-white rounded-md">
                            <p className="text-2xl pt-2 px-2 font-bold">
                                Part Time
                            </p>
